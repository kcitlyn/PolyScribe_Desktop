...
def theme_display_names():
    """Names shown in the theme picker."""
    return list(THEMES.keys())


def theme_from_display_name(display_name):
    """Resolve a picker selection to a theme name (falls back to default)."""
    return display_name if display_name in THEMES else DEFAULT_THEME
